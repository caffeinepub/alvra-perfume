    ...
    extend: {
      colors: {
        ...
        obsidian: {
          ...
          2: "oklch(var(--obsidian-2))",
          3: "oklch(var(--obsidian-3))",
        },
      },
      fontFamily: {
        sans: ['"Cabinet Grotesk"', "sans-serif"],
        display: ['"Playfair Display"', "serif"],
        luxury: ['"Fraunces"', "serif"],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "pulse-gold": {
          "0%, 100%": { opacity: "1", boxShadow: "0 0 20px oklch(var(--gold) / 0.3)" },
          "50%": { opacity: "0.8", boxShadow: "0 0 40px oklch(var(--gold) / 0.5)" },
        },
        shimmer: {
